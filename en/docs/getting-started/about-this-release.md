...
WSO2 API Microgateway 3.2.0 (WSO2 MGW 320) is the successor of WSO2 API Microgateway version 3.1.0 For more information on WSO2 API Microgateway, see the [overview]({{base_path}}/getting-started/overview/) and visit our [webiste.](https://wso2.com/api-management/api-microgateway/)
...
-   **Custom Claims Mapping for JWTs**
    : The WSO2 API Microgateway have capability to transform the remote claims (in the inbound JWT Token) and include them 
    in the generated backend JWT token. More information can be found from [support-custom-claims-mapping]({{base_path}}/how-tos/support-custom-claims-mapping).
