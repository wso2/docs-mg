...
-   [Enabling service discovery](#ServiceDiscovery-Enablingservicediscovery)
-   [Changing the API endpoint URL via etcd](#ServiceDiscovery-ChangingtheAPIendpointURLviaetcd)

### Enabling service discovery

Enable service discovery using etcd on WSO2 API Microgateway as follows:

1.  Make sure to install and set up all the [installation prerequisites](_Install_on_VM_) .
2.  Configure and start the etcd server.
    ...
    4.  Store the key-value pair in the etcd server.
        ...
        -   [**Format**](#format-store-key-value4)
        -   [**Example**](#example-store-key-value5)
        -   [**Response**](#response-store-key-value6)
        ...
        ```
            ...
            -   [**Response**](#response-chk-key-value)
        ``` java
...
3.  Create an API Microgateway project (e.g., petstore-project).
    ...
    ```
        ...
        -   [**Format**](#format-auth-token1)
        -   [**Example**](#example-auth-token2)
        -   [**Response**](#response-auth-token3)
    ...
    ```
        ...
        -   [**Format**](#format-store-key-value)
        -   [**Example**](#example-store-key-value2)
        -   [**Response**](#response-store-key-value3)
